...
class TestMinMaxScoreCalculator(unittest.TestCase):
    ...
    def test_getMaxScore(self):
        ...
        maxScoreTeam1 = MinMaxScoreCalculator(1, leagueModel)
        maxScoreTeam2 = MinMaxScoreCalculator(2, leagueModel)
        maxScoreTeam3 = MinMaxScoreCalculator(3, leagueModel)
        maxScoreTeam4 = MinMaxScoreCalculator(4, leagueModel)
    ...
    def test_getMinScore(self):
        ...
        weekList = [week1, week2, week3]
        leagueModel = LeagueModel(123456, "test", 6, teamList, weekList)
        minScoreTeam1 = MinMaxScoreCalculator(1, leagueModel)
        minScoreTeam2 = MinMaxScoreCalculator(2, leagueModel)
        minScoreTeam3 = MinMaxScoreCalculator(3, leagueModel)
        minScoreTeam4 = MinMaxScoreCalculator(4, leagueModel)
