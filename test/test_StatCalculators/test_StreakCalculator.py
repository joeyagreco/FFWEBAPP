...
class TestStreakCalculator(unittest.TestCase):
    ...
    def test_getLossStreaks(self):
        ...
        self.assertEqual("Week 2, 2020", lossStreaks_2020[0].getStartDate())
        self.assertEqual("team2", lossStreaks_2020[0].getStartTeam().getTeamName())
        self.assertEqual("Week 3, 2020", lossStreaks_2020[0].getEndDate())
        self.assertEqual("team2", lossStreaks_2020[0].getEndTeam().getTeamName())
        ...
        self.assertEqual("Week 2, 2020", lossStreaks_bothYears[0].getStartDate())
