...
class TestStreakCalculator(unittest.TestCase):
    ...
    def test_getWinStreaks(self):
        ...
        self.assertEqual("Week 2, 2020", winStreaks_2020[0].getFirstDate())
        self.assertEqual("team1", winStreaks_2020[0].getFirstTeam().getTeamName())
        self.assertEqual("Week 3, 2020", winStreaks_2020[0].getLastDate())
        self.assertEqual("team1", winStreaks_2020[0].getLastTeam().getTeamName())
        ...
        self.assertEqual("Week 2, 2020", winStreaks_bothYears[0].getFirstDate())
        self.assertEqual("team1", winStreaks_bothYears[0].getFirstTeam().getTeamName())
        self.assertEqual("Week 1, 2021", winStreaks_bothYears[0].getLastDate())
        self.assertEqual("team1", winStreaks_bothYears[0].getLastTeam().getTeamName())
    ...
    def test_getLossStreaks(self):
        ...
        self.assertEqual(2, lossStreaks_2020[0].getOwner().getTeamId())
        self.assertEqual(2, lossStreaks_2020[0].getStreakNumber())
        self.assertEqual("Week 2, 2020", lossStreaks_2020[0].getFirstDate())
        self.assertEqual("team2", lossStreaks_2020[0].getFirstTeam().getTeamName())
        self.assertEqual("Week 3, 2020", lossStreaks_2020[0].getLastDate())
        self.assertEqual("team2", lossStreaks_2020[0].getLastTeam().getTeamName())
        ...
        self.assertEqual(2, lossStreaks_bothYears[0].getOwner().getTeamId())
        self.assertEqual(3, lossStreaks_bothYears[0].getStreakNumber())
        self.assertEqual("Week 2, 2020", lossStreaks_bothYears[0].getFirstDate())
        self.assertEqual("team2", lossStreaks_bothYears[0].getFirstTeam().getTeamName())
        self.assertEqual("Week 1, 2021", lossStreaks_bothYears[0].getLastDate())
        self.assertEqual("team2", lossStreaks_bothYears[0].getLastTeam().getTeamName())
