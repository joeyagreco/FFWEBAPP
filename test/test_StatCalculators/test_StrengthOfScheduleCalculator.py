...
class TestStrengthOfScheduleCalculator(unittest.TestCase):
    ...
    def test_getStrengthOfSchedule(self):
        ...
        sosTeam1_vs2 = StrengthOfScheduleCalculator(1, leagueModel).getStrengthOfSchedule(vsTeamIds=[2])
        sosTeam1_vs3 = StrengthOfScheduleCalculator(1, leagueModel).getStrengthOfSchedule(vsTeamIds=[3])
        ...
        sosTeam1_allParams = StrengthOfScheduleCalculator(1, leagueModel).getStrengthOfSchedule(throughWeek=2, vsTeamIds=[2])
        ...
        self.assertEqual(1, sosTeam1_2)
        self.assertEqual(1, sosTeam1_vs2)
        self.assertEqual(0, sosTeam1_vs3)
        self.assertEqual(1, sosTeam1_only2)
        self.assertEqual(1, sosTeam1_only1and2)
        self.assertEqual(1, sosTeam1_allParams)
        self.assertEqual(1, sosTeam1_default)
