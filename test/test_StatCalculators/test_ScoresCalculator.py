...
class TestScoresCalculator(unittest.TestCase):
    ...
    def test_getMinScore(self):
        ...
        weekList = [week1, week2, week3]
        leagueModel = LeagueModel(123456, "test", 6, teamList, weekList)
        minScoreTeam1_1 = ScoresCalculator(1, leagueModel).getMinScore(throughWeek=1)
        minScoreTeam1_2 = ScoresCalculator(1, leagueModel).getMinScore(throughWeek=2)
    ...
    def test_getPlusMinus(self):
        ...
        weekList = [week1, week2, week3]
        leagueModel = LeagueModel(123456, "test", 6, teamList, weekList)
        plusMinusTeam1_1 = ScoresCalculator(1, leagueModel).getPlusMinus(throughWeek=1)
        plusMinusTeam1_2 = ScoresCalculator(1, leagueModel).getPlusMinus(throughWeek=2)
    ...
    def test_getStandardDeviation(self):
        ...
        weekList = [week1, week2, week3]
        leagueModel = LeagueModel(123456, "test", 6, teamList, weekList)
        standardDeviationTeam1_1 = ScoresCalculator(1, leagueModel).getStandardDeviation(throughWeek=1)
        standardDeviationTeam1_2 = ScoresCalculator(1, leagueModel).getStandardDeviation(throughWeek=2)
    ...
    def test_getPercentageOfLeagueScoring(self):
        ...
        percentageTeam1_allParams = ScoresCalculator(1, leagueModel).getPercentageOfLeagueScoring(week=1, vsTeamIds=[2])
