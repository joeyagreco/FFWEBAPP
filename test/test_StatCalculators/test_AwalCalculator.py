...
class TestAwalCalculator(unittest.TestCase):
    ...
    def test_getAwalPerGame(self):
        ...
        yearDict = {"2020": year2020, "2021": year2021}
        leagueModel = LeagueModel(123456, "test", 6, yearDict)
        awalTeam1_1 = AwalCalculator(1, leagueModel, [2020], 0, 0).getAwalPerGame(throughWeek=1)
        awalTeam1_2 = AwalCalculator(1, leagueModel, [2020], 0, 0).getAwalPerGame(throughWeek=2)
        awalTeam1_vs2 = AwalCalculator(1, leagueModel, [2020], 0, 0).getAwalPerGame(vsTeamIds=[2])
        awalTeam1_vs3 = AwalCalculator(1, leagueModel, [2020], 0, 0).getAwalPerGame(vsTeamIds=[3])
        awalTeam1_only2 = AwalCalculator(1, leagueModel, [2020], 0, 0).getAwalPerGame(onlyWeeks=[2])
        awalTeam1_only1and2 = AwalCalculator(1, leagueModel, [2020], 0, 0).getAwalPerGame(onlyWeeks=[1, 2])
        awalTeam1_allParams = AwalCalculator(1, leagueModel, [2020], 0, 0).getAwalPerGame(throughWeek=1, vsTeamIds=[2])
        awalTeam1_default = AwalCalculator(1, leagueModel, [2020], 0, 0).getAwalPerGame()
        awalTeam1_2021 = AwalCalculator(1, leagueModel, [2021], 1, 0).getAwalPerGame()
        awalTeam1_bothYears = AwalCalculator(1, leagueModel, [2020, 2021], 1, 0).getAwalPerGame()
        self.assertIsInstance(awalTeam1_1, float)
        self.assertEqual(0.2, awalTeam1_1)
        self.assertEqual(0.2, awalTeam1_2)
        self.assertEqual(0.2, awalTeam1_vs2)
        self.assertEqual(0, awalTeam1_vs3)
        self.assertEqual(0.2, awalTeam1_only2)
        self.assertEqual(0.2, awalTeam1_only1and2)
        self.assertEqual(0.2, awalTeam1_allParams)
        self.assertEqual(0.2, awalTeam1_default)
        self.assertEqual(0.45, awalTeam1_2021)
        self.assertEqual(0.33, awalTeam1_bothYears)
