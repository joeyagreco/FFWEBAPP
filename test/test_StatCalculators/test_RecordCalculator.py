...
class TestRecordCalculator(unittest.TestCase):
    ...
    def test_getLosses(self):
        ...
        lossesTeam1_1 = RecordCalculator(1, leagueModel).getLosses(throughWeek=1)
        lossesTeam1_2 = RecordCalculator(1, leagueModel).getLosses(throughWeek=2)
        ...
        lossesTeam1_only2 = RecordCalculator(1, leagueModel).getLosses(onlyWeeks=[2])
        lossesTeam1_only1and2 = RecordCalculator(1, leagueModel).getLosses(onlyWeeks=[1, 2])
        lossesTeam1_allParams = RecordCalculator(1, leagueModel).getLosses(throughWeek=1, vsTeamIds=[2])
        ...
        self.assertEqual(1, lossesTeam1_only2)
    ...
    def test_getTies(self):
        ...
        weekList = [week1, week2]
        leagueModel = LeagueModel(123456, "test", 6, teamList, weekList)
        tiesTeam1_1 = RecordCalculator(1, leagueModel).getTies(throughWeek=1)
    ...
    def test_getWinPercentage(self):
        ...
        leagueModel = LeagueModel(123456, "test", 6, teamList, weekList)
        winPercentageTeam1_1 = RecordCalculator(1, leagueModel).getWinPercentage(throughWeek=1)
        winPercentageTeam1_2 = RecordCalculator(1, leagueModel).getWinPercentage(throughWeek=2)
        winPercentageTeam1_3 = RecordCalculator(1, leagueModel).getWinPercentage(throughWeek=3)
        ...
        winPercentageTeam1_only2 = RecordCalculator(1, leagueModel).getWinPercentage(onlyWeeks=[2])
        winPercentageTeam1_only1and3 = RecordCalculator(1, leagueModel).getWinPercentage(onlyWeeks=[1, 3])
        winPercentageTeam1_allParams = RecordCalculator(1, leagueModel).getWinPercentage(throughWeek=1, vsTeamIds=[2])
