...
class TestPpgCalculator(unittest.TestCase):
    ...
    def test_getPpg(self):
        ...
        ppgTeam1_1 = PpgCalculator(1, leagueModel).getPpg(week=1)
        ppgTeam1_2 = PpgCalculator(1, leagueModel).getPpg(week=2)
        ppgTeam1_3 = PpgCalculator(1, leagueModel).getPpg(week=3)
        ppgTeam1_vs2 = PpgCalculator(1, leagueModel).getPpg(vsTeamIds=[2])
        ppgTeam1_vs3 = PpgCalculator(1, leagueModel).getPpg(vsTeamIds=[3])
        ppgTeam1_allParams = PpgCalculator(1, leagueModel).getPpg(vsTeamIds=[2], week=1)
