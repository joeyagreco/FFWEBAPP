class Constants:
    ...
    LEAGUE_STATS_STAT_TITLES = sorted([OWNER_COMPARISON_STAT_TITLE, ALL_SCORES_STAT_TITLE, MARGINS_OF_VICTORY_STAT_TITLE, WINNING_STREAKS_STAT_TITLE, LOSING_STREAKS_STAT_TITLE])
